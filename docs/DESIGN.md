...
Ordem: município, organização responsável, situação original, eixo/tipo/subtipo, faixa de investimento e ano de cadastro. Filtros múltiplos devem mostrar quantidade selecionada. A ação **Aplicar filtros** recebe o gradiente; **Limpar filtros** é secundária.
